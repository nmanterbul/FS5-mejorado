...
public class PartidosDao {
    public static List<Partido> obtenerPartidos(int idTorneo, int idJornada) {
        ...
        for (int i = 0; i < result.length; i++) {
            ...
            int idPartido = (int) result[i][0];
            String equipoLocal = (String) result[i][1];
            String equipoVisitante = (String) result[i][2];
            int golesLocal = (int) result[i][3];
            int golesVisitante = (int) result[i][4];
            int idJornada1 = (int) result[i][5];
            int idTorneo1 = (int) result[i][6];
