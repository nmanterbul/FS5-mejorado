...
public class Jugador {
    ...
    public int getPosicionGoleadores() {
        return posicionGoleadores;
    }

    public void setPosicionGoleadores(int posicionGoleador) {
        this.posicionGoleadores = posicionGoleador;
    }
